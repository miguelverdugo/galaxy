"""
Standard suite of tests for Sources

copied from https://github.com/astronomyk/ScopeSim_Templates/blob/master/scopesim_templates/tests/test_source_validation/test_validate_content.py
